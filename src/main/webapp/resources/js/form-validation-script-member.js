	...
	$(document).ready(function() { 
		...
		//아이디 중복확인 
		$("#mem_id").blur(function() { //.blur는 포커스를 잃을 떄 사용 
			if($('#mem_id').val()==''){ 
				...
				$('#id_check').css('color', 'red'); 
					...
					$('#id_check').css('color', 'red'); 
						...
						$.ajax({ 
							...
							//url: '/idCheck.do?mem_id=' + mem_id,
							url: '/idCheck.do',
							dateType: 'json',
							contentType: "application/json; charset=UTF-8",
							success : function(data) {  //data값이 비어있다. data에는 controller에서 반환한 수가 나와야한다. 
								console.log("중복검사 테스트  0 = 중복 X  || 1 = 중복  :: " + data);
								if(data.cnt > 0){ 
...
/*https://m.blog.naver.com/PostView.nhn?blogId=vnemftnsska2&logNo=221407559074&proxyReferer=https:%2F%2Fwww.google.com%2F*/